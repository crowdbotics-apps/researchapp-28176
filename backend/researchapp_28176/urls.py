"""researchapp_28176 URL Configuration
...
admin.site.site_header = "researchapp"
admin.site.site_title = "researchapp Admin Portal"
admin.site.index_title = "researchapp Admin"

# swagger
api_info = openapi.Info(
    title="researchapp API",
    default_version="v1",
    description="API documentation for researchapp App",
)
